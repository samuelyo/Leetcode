package com.leetcode.NumbersWithSameConsecutiveDifferences;
...
public class NumbersWithSameConsecutiveDifferences {
    public static void main(String[] args) {
        int[] res = numsSameConsecDiff(2, 1);
    ...
    public static void dfs(int N, int K, List<Integer> list, int number) {
