package com.leetcode.BraceExpansionII;
...
public class BraceExpansionII {
    ...
    private static List<String> extractResult(Stack<String> stack) {
    ...
    private static void resolveBrackets(Stack<String> stack) {
        StringBuilder sb = new StringBuilder();
    ...
    private static void cartesian(Stack<String> stack) {
